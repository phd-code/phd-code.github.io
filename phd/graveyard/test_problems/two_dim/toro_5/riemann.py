...
def riemann(domain_length=2.0, diaphram=1.0, cells=128, gamma=1.4, time_out=0.015,
        density_left=5.99924, velocity_left=19.5975, pressure_left=460.894, density_right=5.99242, velocity_right=-6.19633, pressure_right=46.0950,
        mpa=1.0):
